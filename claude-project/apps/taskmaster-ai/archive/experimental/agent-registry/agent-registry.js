...
class AgentRegistryWidget {
    ...
    renderAgentCard(agent, container) {
        ...
        const lastSeen = this.formatLastSeen(agent.lastSeen);
        ...
        card.innerHTML = `
            ...
            <div class="agent-capabilities">
                <p class="capabilities-title">Capabilities:</p>
            ...
            <div class="agent-actions">
                ...
                <button class="agent-action-btn" onclick="agentRegistry.assignTask('${agent.id}')">
                    Assign Task
                </button>
                ${agent.status === 'active' ? 
                    `<button class="agent-action-btn" onclick="agentRegistry.pauseAgent('${agent.id}')">Pause</button>` :
                    `<button class="agent-action-btn primary" onclick="agentRegistry.activateAgent('${agent.id}')">Activate</button>`
                }
            </div>
